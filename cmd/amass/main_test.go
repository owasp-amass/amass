...
func TestGetallSourceNames(t *testing.T) {
	...
	want := []string{"AlienVault", "ArchiveIt", "ArchiveToday", "Arquivo", "Ask", "Baidu",
		...
		"DNSTable", "Dogpile", "Entrust", "Exalead", "GitHub", "Google", "GoogleCT", "HackerOne", "HackerTarget", "IPv4Info",
		"LoCArchive", "Mnemonic", "Netcraft", "NetworksDB", "OpenUKArchive", "PassiveTotal", "Pastebin", "PTRArchive", "RADb",
